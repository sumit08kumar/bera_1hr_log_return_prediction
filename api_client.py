...
class FlaskAPIClient:
    ...
    def fetch_data(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["FETCH_DATA"])

    def train_model(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["TRAIN"])

    def predict(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["PREDICT"])

    def evaluate_model(self) -> Dict[str, Any]:
        return self._make_request("GET", config.API["ENDPOINTS"]["EVALUATE"])

    def save_model(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["SAVE_MODEL"])

    def load_model(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["LOAD_MODEL"])

    def forecast(self) -> Dict[str, Any]:
        return self._make_request("POST", config.API["ENDPOINTS"]["FORECAST"])
